...
<div class="container">
    <div>
        <c:if test="${param.added ne null}">
            <p class="text-info">Movie added successfully </p>
        </c:if>
    </div>
    <div class="row">
        <form action="/admin/add-movie" method="post" enctype="multipart/form-data" commandName="${movieRequest}">
            <div class="form-group">
                <label for="name">Name</label>
                <input type="text" name="name" required class="form-control" required id="name"/>
            </div>
            ...
            <div class="form-group">
                ...
                <input type="number" name="releaseYear" value="*{releaseYear}" required class="form-control" required id="releaseYear"/>
            </div>

            <div class="form-group">
                <label for="rating">Rating</label>
                <input type="number" name="rating" value="*{rating}" required class="form-control" required id="rating"/>
            </div>

            <div class="form-group">
                <label for="description">Description</label>
                <textarea id="description" required class="form-control" id="description" name="description" rows="3"></textarea>
            </div>
